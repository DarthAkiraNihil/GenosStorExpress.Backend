...
namespace GenosStorExpress.Application.Service.Implementation.Entity.Items.ComputerComponents {
    public class SataSSDService: AbstractSSDService, ISataSSDService {
        ...
        public SataSSDService(IItemTypeService itemTypeService, IActiveDiscountService activeDiscountService, IVendorService vendorService, ISSDControllerService ssdControllerService, IGenosStorExpressRepositories repositories) : base(itemTypeService, activeDiscountService, vendorService, ssdControllerService) {
