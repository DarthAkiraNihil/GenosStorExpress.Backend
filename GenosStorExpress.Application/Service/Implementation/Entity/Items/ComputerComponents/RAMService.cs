...
namespace GenosStorExpress.Application.Service.Implementation.Entity.Items.ComputerComponents {
    public class RAMService: AbstractComputerComponentService, IRAMService {
        ...
        public RAMService(IItemTypeService itemTypeService, IActiveDiscountService activeDiscountService, IVendorService vendorService, IGenosStorExpressRepositories repositories, IRAMTypeService ramTypeService) : base(itemTypeService, activeDiscountService, vendorService) {
